...
public class SSObjectMetadataEmptyDialog extends Dialog implements
		android.view.View.OnClickListener {

	SSObjectActivity mContext;
	TextView metadataNotFoundTitle, description, btn_accept;

	public SSObjectMetadataEmptyDialog(Context context) {
		super(context);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		metadataNotFoundTitle = (TextView) findViewById(R.id.object_entity_empty_title);
		...
		metadataNotFoundTitle.setText(R.string.empty_metadata_title);
		description.setText(R.string.empty_metadata_desc);
	}
