...
public class SSObjectGeospatialEmptyDialog extends Dialog implements
		android.view.View.OnClickListener {

	SSObjectActivity mContext;
	TextView geospatialNotFoundTitle,description,btn_accept;


	public SSObjectGeospatialEmptyDialog(Context context) {
		super(context);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		geospatialNotFoundTitle = (TextView) findViewById(R.id.object_entity_empty_title);
		...
		geospatialNotFoundTitle.setText(R.string.empty_geospatial_title);
		description.setText(R.string.empty_geospatial_desc);
	}
