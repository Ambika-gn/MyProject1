...
public class SSObjectInteractionsEmptyDialog extends Dialog implements
		android.view.View.OnClickListener {

	SSObjectActivity mContext;
	TextView interactionsNotFoundTitle,description,btn_accept;


	public SSObjectInteractionsEmptyDialog(Context context) {
		super(context);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		interactionsNotFoundTitle = (TextView) findViewById(R.id.object_entity_empty_title);
		...
		interactionsNotFoundTitle.setText(R.string.empty_interactions_title);
		description.setText(R.string.empty_interactions_desc);
	}
